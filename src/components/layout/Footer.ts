      ...
      <div class="footer-main-body">
        <div class="container footer-container">
          ...
          <div class="footer-columns-grid">
            ...
            <div class="footer-col-brand">
              ...
              <div class="footer-social-row">
                ...
                <a href="${settings.instagramUrl || '#'}" target="_blank" rel="noopener noreferrer" class="footer-social-pill" aria-label="Instagram">
                ...
                <a href="${settings.facebookUrl || '#'}" target="_blank" rel="noopener noreferrer" class="footer-social-pill" aria-label="Facebook">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="footer-col-contacts">
              ...
              <ul class="footer-contacts-list">
                <li>
                  <a href="tel:${settings.phoneDisplay.replace(/\s+/g, '')}" class="footer-contact-link">
                ...
                <li>
                  <a href="mailto:${settings.email}" class="footer-contact-link">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <li>
                  <div class="footer-contact-item">
                    ...
                    <span>${settings.companyName}, ${settings.headquarters}</span>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="footer-copyright-bar">
            <p>
              &copy; ${currentYear} <strong>${settings.brandName}</strong> — ${settings.companyName}. Tous droits réservés.
